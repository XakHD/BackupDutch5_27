...
//          Payments are currently not live(test mode)
//         </p>
...
//           <button 
//             // onClick={handleSubscription}
//             className="flex w-full items-center justify-center rounded-sm bg-primary p-3 text-base font-semibold text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp mt-2"
//           >
